  ...
  factory: (require) => {
    ...
    function RemoteAccessSection(props) {
      ...
      var fetchDhcp = function () {
        fetch("/remote-access/dhcp", { credentials: "same-origin" })
          .then(function (r) { return r.json(); })
          .then(function (d) { if (d && d.address) set("dhcpAddress", d.address); })
          .catch(function (e) { console.error("[dsh-remote-access] dhcp fetch failed", e); });
      };
