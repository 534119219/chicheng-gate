window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var NS = "chicheng-gate";

    var zh = {
      nav: "赤橙网关",
      title: "赤橙网关 · 访问控制与内网穿透",
      ...
      frpcTrustedHosts: "额外可信 Host（可选）",
      frpcTrustedHostsPh: "逗号/空格分隔，如 panel.example.com 或 my.frp.com；访问这些域名时免被连接围栏拦截",
      frpcStatus: "运行状态",
      frpcDisabled: "未启用",
      frpcRunning: "运行中",
      frpcNotRunning: "未运行",
    ...
    var en = {
      nav: "Chicheng Gate",
      title: "Chicheng Gate · Access Control & Tunneling",
      ...
      frpcTrustedHosts: "Extra trusted hosts (optional)",
      frpcTrustedHostsPh: "Comma/space separated, e.g. panel.example.com or my.frp.com; hosts in this list bypass the connection fence",
      frpcStatus: "Status",
    ...
    function LanGateSection(props) {
      ...
      var authMethod = value.frpcAuthMethod === "none" ? "none" : "token";
      ...
      var frpcTrustedHosts = typeof value.frpcTrustedHosts === "string" ? value.frpcTrustedHosts : "";
      ...
      useEffect(function () {
        var alive = true;
        var poll = function () {
          fetch("/chicheng-gate/status", { credentials: "same-origin" })
            .then(function (r) { return r.json(); })
      ...
      return createElement("div", { style: sectionStyle },
        ...
        createElement(Card, { heading: t("frpcTitle") },
          ...
          authMethod !== "none" ? createElement(Field, { label: t("frpcToken") },
          ...
          createElement(Field, { label: t("frpcTrustedHosts"), desc: t("frpcTrustedHostsPh") },
            createElement("input", { value: frpcTrustedHosts, placeholder: t("frpcTrustedHostsPh"), onChange: function (e) { set("frpcTrustedHosts", e.target.value); }, style: textInputStyle })
          )
        ),
